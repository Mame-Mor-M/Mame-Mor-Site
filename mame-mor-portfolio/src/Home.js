...
function Home() {
  const game_thumbnails = [
    { id: "Touche-Tempo", content: `${process.env.PUBLIC_URL}/Thumbnails/ToucheTempo.png`, name: "Touche Tempo", desc: "A rhythm game where one masters the art of Fencing through music, utilize three stances to best your opponents in The Devil's Tournament and earn the illustrious prize of his hands and finesse", video: "https://github.com/Mame-Mor-M/Mame-Mor-Site/releases/download/PortfolioVids/Touche-TempoCLIP.mp4", tech: [FaUnity, PiFileCSharp, FaFigma] },
