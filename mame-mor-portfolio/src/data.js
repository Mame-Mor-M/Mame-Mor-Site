  ...
  const game_thumbnails = [
    {
      ...
      gallery: [`${process.env.PUBLIC_URL}/Images/Upperdut_1.png`, `${process.env.PUBLIC_URL}/Images/Upperdut_2.png`, `${process.env.PUBLIC_URL}/Images/Upperdut_3.png`, `${process.env.PUBLIC_URL}/Images/Upperdut_4.png`],
      ...
      systemImage: [`${process.env.PUBLIC_URL}/Images/upperdutInspector.png`, `${process.env.PUBLIC_URL}/Images/UpperdutBoxes.png`],
    ...
    },
    {
      ...
      gallery: [`${process.env.PUBLIC_URL}/Images/PYP_Game.png`, `${process.env.PUBLIC_URL}/Images/PYP_End.png`, `${process.env.PUBLIC_URL}/Images/PYP_Bar.png`],
      systemImage: [`${process.env.PUBLIC_URL}/Images/PYP_Editor.png`, `${process.env.PUBLIC_URL}/Images/PYP_EVENTBAR.png`, `${process.env.PUBLIC_URL}/Thumbnails/BusRush.png`],
      systemVideo: [""],
      systemLink: ["https://github.com/Mame-Mor-M/PickYourPoison/tree/main/pick-your-poison", "awd"],
...

    {
      ...
      gallery: [`${process.env.PUBLIC_URL}/Images/citizenjanedialogue.jpg`, `${process.env.PUBLIC_URL}/Images/citizenjaneinquire.jpg`, `${process.env.PUBLIC_URL}/Images/citizenjaneinventory.jpg`, `${process.env.PUBLIC_URL}/Images/citizenjanemenu.jpg`, `${process.env.PUBLIC_URL}/Images/citizenjaneposter.png`],
      systemImage: [`${process.env.PUBLIC_URL}/Images/JaneInventory.png`, `${process.env.PUBLIC_URL}/Images/JaneMove.png`,],
      systemVideo: ["/projectGifs/UpperdutInspector.mp4"],
    ...
    },
    {
      ...
      gallery: [`${process.env.PUBLIC_URL}/Images/Paws_1.png`, `${process.env.PUBLIC_URL}/Images/Paws_2.png`, `${process.env.PUBLIC_URL}/Images/Paws_3.png`, `${process.env.PUBLIC_URL}/Images/Paws_4.png`],
      systemImage: [`${process.env.PUBLIC_URL}/Images/PawsSystem.png`],
      systemVideo: [""],
    ...
    },
    {
      ...
      gallery: [`${process.env.PUBLIC_URL}/Images/Endzone_Defense.png`, `${process.env.PUBLIC_URL}/Images/Endzone_Down.png`, `${process.env.PUBLIC_URL}/Images/Endzone_Gain.png`, `${process.env.PUBLIC_URL}/Images/Endzone_Field-.png`],
      systemImage: [`${process.env.PUBLIC_URL}/Images/Endzone_Play.png`, `${process.env.PUBLIC_URL}/Images/Endzone_Doctor.png`,],
      systemVideo: ["/projectGifs/UpperdutInspector.mp4"],
    ...
    },
    {
      ...
      gallery: [`${process.env.PUBLIC_URL}/Images/Bus.png`, `${process.env.PUBLIC_URL}/Images/BusCity.png`, `${process.env.PUBLIC_URL}/Images/City.png`],
      systemImage: [`${process.env.PUBLIC_URL}/Images/BusRushInspector.png`, `${process.env.PUBLIC_URL}/Images/BRPassengers.png`],
      systemVideo: ["/projectGifs/UpperdutInspector.mp4"],
...

    {
      ...
      gallery: [`${process.env.PUBLIC_URL}/Images/Othello_Board.png`, `${process.env.PUBLIC_URL}/Images/Othello_History.png`, `${process.env.PUBLIC_URL}/Images/Othello_Save.png`],
      systemImage: [`${process.env.PUBLIC_URL}/Thumbnails/Othello.png`,],
      systemVideo: ["/projectGifs/UpperdutInspector.mp4"],
...

    {
      ...
      gallery: [`${process.env.PUBLIC_URL}/Images/PG_Analysis.png`, `${process.env.PUBLIC_URL}/Images/PG_Analysis2.jpg`, `${process.env.PUBLIC_URL}/Images/PG_Inspect.jpg`, `${process.env.PUBLIC_URL}/Images/PG_TL.png`, `${process.env.PUBLIC_URL}/Images/PG_Twitter.png`],
      systemImage: [`${process.env.PUBLIC_URL}/PGPy.png`],
      systemVideo: [""],
    ...
    desc: "Pulsefex is an embedded systems project that captures and displays real-time heart rate and SpO2 levels. The system is built on the STM32WB55RG MCU and interfaces with the MAX30102 pulse oximeter and TMP102 temperature sensor, with real-time data output to an SSD1306 OLED screen. This was my first embedded systems project and as such I was eager to contribute.\n\nMy primary responsibility was the low-level interfacing of the MAX30102 with the STM32WB MCU via I²C, implemented entirely in C. I developed custom drivers to extract photoplethysmography (PPG) signals, which the sensor uses to detect pulse and blood oxygen saturation through infrared light reflectance. ",
      ...
      gallery: [`${process.env.PUBLIC_URL}/Images/pulsefexbpm.png`, `${process.env.PUBLIC_URL}/Images/pulsefexbpm2.jpg`,],
      systemImage: [`${process.env.PUBLIC_URL}/Thumbnails/Pulsefex.jpg`,],
      systemVideo: [""],
